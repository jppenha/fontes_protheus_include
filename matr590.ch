...
AADD(aCampos,{ "TB_RANKIN" ,"N",18,0 } )        		// Ranking conforme Valor faturamento
AADD(aCampos,{ "TB_TIPO"   ,"C",03,0 } )        		
AADD(aCampos,{ "TB_CONT"   ,"N",18,nDecs} )
...
If mv_par07 == 1			// Listar por Cliente   
	...
	While !Eof()
		RecLock(cNomArq,.F.)
		Replace TB_CONT With 1000000000000 - (cNomArq)->TB_VALOR3 + (cNomArq)->TB_VALOR6
		MsUnlock()
